...
| **Duplicate data** | Copy everything everywhere | **Normalisation**: store once, reference many times |
...
These problems become invisible errors that corrupt reports and decisions.
